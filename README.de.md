...
Dieses Repository bündelt aktuell **56 wiederverwendbare Skills**: **30 Top-Level-Skills**, die direkt hier gepflegt werden, plus **18 vendorte Design-Skills** unter [`impeccable/`](impeccable/README.md), plus **8 vendorte GSAP-Animations-Skills** unter [`gsap-skills/`](gsap-skills/). Klone es nach `~/.agents/skills/ok-skills`; die enthaltenen Verzeichnisse entsprechen bereits dem Layout, das `AGENTS.md`-gesteuerte Workflows erwarten.
...
- [chrome-cdp](chrome-cdp/SKILL.md): Verbindung zu einer bereits laufenden lokalen Chrome-Sitzung per CDP für leichte Seiteninspektion und Interaktion.
...
| [chrome-cdp](chrome-cdp/SKILL.md) | Verbindet sich per CDP mit einer bereits laufenden lokalen Chrome-Sitzung für leichte Tab-Inspektion, Screenshots, DOM-Zugriff, Eingaben und Navigation. | [pasky/chrome-cdp-skill](https://github.com/pasky/chrome-cdp-skill/tree/main/skills/chrome-cdp) |
...
Einige Skills enthalten zusätzliche Lizenzdateien oder Hinweise zu skill-spezifischen Assets und Attributionen, darunter [`docx/`](docx/), [`pptx/`](pptx/), [`impeccable/`](impeccable/README.md), [`gsap-skills/`](gsap-skills/), [`skill-creator/`](skill-creator/) und [`xlsx/`](xlsx/).
