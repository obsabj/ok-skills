...
このリポジトリには現在 **44 個の再利用可能な skills** が含まれています。内訳は、このリポジトリで直接管理している **26 個のトップレベル skills** と、[`impeccable/`](impeccable/README.md) 配下に vendored bundle として収録されている **18 個のデザイン skills** です。`~/.agents/skills/ok-skills` に clone すれば、そのまま `AGENTS.md` ベースのワークフローで使えるディレクトリ構成になっています。
...
- [output-skill](output-skill/SKILL.md): 省略なしの完全出力を強制し、placeholder を禁止する
...
- [redesign-skill](redesign-skill/SKILL.md): 既存の Web サイトやアプリを全面リライトせずに高品質化する
- [vercel-react-best-practices](vercel-react-best-practices/SKILL.md): Vercel Engineering 由来の React / Next.js パフォーマンス指針
- [taste-skill](taste-skill/SKILL.md): より高い裁量で frontend を作るための上級 UI/UX design skill
...
[`impeccable/`](impeccable/README.md) には、[`pbakaus/impeccable`](https://github.com/pbakaus/impeccable) 由来の design-focused bundle が commit `0df1ba59dc80b8b1891ee42eed0ef4e03d7ef165` の状態で vendored されています。
...
| [output-skill](output-skill/SKILL.md) | LLM のデフォルトの出力切り詰め動作を上書きし、完全なコード生成を強制し、placeholder を禁止し、token limit 近辺での出力分割も整える。 | [Leonxlnx/taste-skill](https://github.com/Leonxlnx/taste-skill/tree/main/output-skill) |
...
| [redesign-skill](redesign-skill/SKILL.md) | 既存の Web サイトやアプリを premium quality に引き上げる。現状を監査し、典型的な AI っぽさを見つけ、機能を壊さずに高品質化する。 | [Leonxlnx/taste-skill](https://github.com/Leonxlnx/taste-skill/tree/main/redesign-skill) |
...
| [taste-skill](taste-skill/SKILL.md) | 上級 UI/UX Engineer 向けの skill。LLM のデフォルト設計バイアスを避け、定量ルール、厳密な component architecture、CSS hardware acceleration、バランスの取れた design engineering を重視する。 | [Leonxlnx/taste-skill](https://github.com/Leonxlnx/taste-skill/tree/main/taste-skill) |
