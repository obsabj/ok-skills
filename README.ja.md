...
このリポジトリには現在 **46 個の再利用可能な skills** が含まれています。内訳は、このリポジトリで直接管理している **28 個のトップレベル skills** と、[`impeccable/`](impeccable/README.md) 配下に vendored bundle として収録されている **18 個のデザイン skills** です。`~/.agents/skills/ok-skills` に clone すれば、そのまま `AGENTS.md` ベースのワークフローで使えるディレクトリ構成になっています。
...
[`impeccable/`](impeccable/README.md) には、[`pbakaus/impeccable`](https://github.com/pbakaus/impeccable) 由来の design-focused bundle が commit `b5af865d84bc1ba1b8bc7104488bc7db50977029` の状態で vendored されています。
